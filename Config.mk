...
QEMU_UPSTREAM_URL ?= https://github.com/abligh/qemu-upstream-4.2-testing.git
SEABIOS_UPSTREAM_URL ?= http://xenbits.xen.org/git-http/seabios.git
else
OVMF_UPSTREAM_URL ?= git://xenbits.xen.org/ovmf.git
#QEMU_UPSTREAM_URL ?= git://xenbits.xen.org/qemu-upstream-4.2-testing.git
QEMU_UPSTREAM_URL ?= git://github.com/abligh/qemu-upstream-4.2-testing.git
SEABIOS_UPSTREAM_URL ?= git://xenbits.xen.org/seabios.git
endif
OVMF_UPSTREAM_REVISION ?= b0855f925c6e2e0b21fbb03fab4b5fb5b6876871
#QEMU_UPSTREAM_REVISION ?= qemu-xen-4.2.1
QEMU_UPSTREAM_REVISION ?= xen-4.2.1-track-github-abligh
